...
class Yuce(object):
    ...
    def startYuce(self):
        ...
        for n in numbers:
            insertsql = insertsql + "INSERT INTO {0}.{1} ({2},{3},{4},{5},{6},{7},{8}) \
            VALUES ('{9}','{10}','{11}',{12},{13},{14},{15});".format( \
    ...
    def getRandom(self):
        ...
        return {'numbers':numbers[0:random.randint(2,5)],'road':roads[0],'beat':beats[0]}